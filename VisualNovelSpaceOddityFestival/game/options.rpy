...
define config.name = _("VisualNovelSpaceOddityFestival")
...
define build.name = "VisualNovelSpaceOddityFestival"
...
define config.save_directory = "VisualNovelSpaceOddityFestival-1689099820"
